(function(window, document) {
  ...
  function initHero() {
    var heroContent = {
      ...
      body:
        'Discover the latest health and wellness research and our guides to living healthier.'
    };
    var heroHtml =
      '<div class="hmlp-hero"><div class="hmlp-hero__content"><h1 class="hmlp-hero__title">' +
      heroContent.title +
      '</h1><p class="hmlp-hero__body">' +
      heroContent.body +
      '</p></div></div>';
  ...
  function stickyNav() {
    ...
    stickyNavLiks.forEach(function(el) {
      return (stickyNavHtml +=
        '<li class="hmlp-nav__item"><a href="#' +
        el.link +
        '" class="hmlp-nav__link js-hmlp-scrollto" alt="Scroll to ' +
        el.label +
        '">' +
        el.label +
        '</a></li>');
    ...
    $('.js-' + lpPrefix + '-scrollto').click(function(e) {
      ...
      if ($(window).width() <= 768) {
        ...
        offset =
          ...
          $('.js-main-header .branding').outerHeight() -
          2;
      }
      $('html, body')
        .stop()
  ...
  function initHealthy() {
    var healthyContent = {
      ...
      product: {
        ...
        price: 2.99,
        url:
          '/shop/product/healthy-magazine-issue-153-the-nutrition-issue-60010306',
    ...
    healthyHtml +=
      '<div class="hmlp-talking-about"><h3 class="hmlp-block__subtitle">' +
      talkingAboutTitle +
      '</h3><ul class="hmlp-talking-about-list">';

    healthyContent.talkingAboutBullets.forEach(function(el) {
      return (healthyHtml +=
        '<li class="hmlp-talking-about-list__item">' + el + '</li>');
    });
    healthyHtml +=
      '</ul></div><p class="hmlp-block-product__price hmlp-block-product__price--mobile">&pound;' +
      healthyContent.product.price +
      '</p><button class="hmlp-quick-add hmlp-quick-add--mobile js-quickadd" data-sku="' +
      healthyContent.product.sku +
      '" data-product-id="' +
      healthyContent.product.prodId +
  ...
  function initHealthySampleBanner() {
    var healthySampleBannerContent = {
      ...
      modalContent: {
        link:
          'https://www.healthy-magazine.co.uk/wp-content/uploads/healthy-october-2019-sampler/',
        scriptLink:
          'https://www.healthy-magazine.co.uk/wp-content/uploads/healthy-october-2019-sampler/files/html/static/embed.js'
      }
    };
    var healthySampleBannerHtml =
      '<div class="hmlp-sample-banner u-c" id="' +
      healthySampleBannerContent.id +
      '"><div class="hmlp-sample-banner__body"><p>' +
      healthySampleBannerContent.label +
      '</p><a href="#" class="hmlp-sample-banner__cta js-hmlp-sample-modal" alt="View Sample">' +
      healthySampleBannerContent.ctaLabel +
      '</a></div><div class="hmlp-modal-wrap"><div class="hmlp-modal"><span class="hmlp-modal__close js-hmlp-modal-close"><i class="fas fa-times"></i></span><a class="fbp-embed" style="max-width: 100%" href="' +
      healthySampleBannerContent.modalContent.link +
      '" data-fbp-lightbox="yes" data-fbp-version="1" data-fbp-width="620px" data-fbp-height="480px">Healthy</a></div></div></div>';
  ...
  function initHealthyMen() {
    ...
    healthyMenHtml +=
      ...
      '</p><span class="hmlp-quick-add hmlp-quick-add--nostock hmlp-quick-add--mobile">Out of stock</span></div>';
  ...
  function initHealthyMenSampleBanner() {
    var healthyMenSampleBannerContent = {
      ...
      modalContent: {
        link:
          'https://www.healthyformen.com/wp-content/uploads/healthy_for_men-sep-oct-2019-sampler/',
        scriptLink:
          'https://www.healthyformen.com/wp-content/uploads/healthy_for_men-sep-oct-2019-sampler/files/html/static/embed.js'
      }
    };
    var healthyMenSampleBannerHtml =
      '<div class="hmlp-sample-banner u-c" id="' +
      healthyMenSampleBannerContent.id +
      '"><div class="hmlp-sample-banner__body"><p>' +
      healthyMenSampleBannerContent.label +
      '</p><a href="#" class="hmlp-sample-banner__cta js-hmlp-sample-modal" alt="View Sample">' +
      healthyMenSampleBannerContent.ctaLabel +
      '</a></div><div class="hmlp-modal-wrap"><div class="hmlp-modal"><span class="hmlp-modal__close js-hmlp-modal-close"><i class="fas fa-times"></i></span><a class="fbp-embed" style="max-width: 100%" href="' +
      healthyMenSampleBannerContent.modalContent.link +
      '" data-fbp-lightbox="yes" data-fbp-version="1" data-fbp-width="620px" data-fbp-height="480px">Healthy</a></div></div></div>';
  ...
  function initTwitterBanner() {
    var twitterBannerContent = {
      ...
      body:
        'Let us know what you think about the new look magazines by tweeting',
      twitterAccountName: '@holland_barrett'
    };
    var twitterBannerHtml =
      '<a href="' +
      twitterBannerContent.link +
      '" target="_blank" class="hmlp-twitter-banner" alt="Tweet Us"><p class="hmlp-twitter-banner__body">' +
      twitterBannerContent.body +
      ' <span class="hmlp-twitter-banner__twitter-account">' +
      twitterBannerContent.twitterAccountName +
      '</span></p><i class="fab fa-twitter hmlp-twitter-banner__twitter-logo"></i></a>';
